#print 1th to 5th disarium numbers
n=1
dc=0
while True:
    dummy=n
...
3.4.taking infinite loop because we dont know upto which number  'n' harshadnumbers  we get.
...
i=1:n=1
    ...
    checks dc in range(1,5) true so print 1
    checks 1==5 false
...
i=2:n=2
    ...
    checks dc in range(1,5) true so print 2
    checks 2==5 false
...
i=3:n=3
    ...
    checks dc in range(1,5) true so print 3
    checks 3==5 false
...
i=4:n=4
    ...
    checks 4==4: True
    so dc is incremented 3 to 4
    checks dc in range(1,5) true so print 4
    checks 4==5 false
...
i=5:n=5
    ...
    checks dc in range(1,5) true so print 5
    checks 5==5 True
