...
i=1:n=1
    ...
    checks 1%1==0 True so print 1 and
...
i=2:n=2
    ...
    checks 2%2==0 True so print 2 and
...
i=4:n=4
    ...
    checks 4%4==0 True so print 4 and
...
i=5:n=5
    ...
    checks 5%5==0 True so print 5 and
