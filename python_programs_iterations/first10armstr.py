#print first 10 armstong numbers
count=int(input())
n=1
ac=0
while True:
...
i=1:n=1
    ...
    checks 1==1: True
    so prints 1 and ac is incremented 0 to 1
    checks 1==5 false
...
i=2:n=2
    ...
    checks 2==2: True
    so prints 2 and ac is incremented 1 to 2
    checks 2==5 false
...
i=3:n=3
    ...
    checks3==3: True
    so prints 3 and ac is incremented 2 to 3
    checks 3==5 false
...
i=4:n=4
    ...
    checks 4==4: True
    so prints 4 and ac is incremented 3 to 4
    checks 4==5 false
...
i=5:n=5
    ...
    checks 5==5: True
    so prints 5 and ac is incremented 4 to 5
    checks 5==5 True
