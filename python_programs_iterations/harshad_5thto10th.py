...
i=1:n=1
    ...
    checks hc in range(1,5) True so print 1
    checks 1==5 false
...
i=2:n=2
    ...
    checks hc in range(1,5) True so print 2
    checks 2==5 false
...
i=3:n=3
    ...
    checks hc in range(1,5) True so print 3
    checks 3==5 false
...
i=4:n=4
    ...
    checks hc in range(1,5) True so print 4
    checks 4==5 false
...
i=5:n=5
    ...
    checks hc in range(1,5) True so print 5
    checks 5==5 true
    loop has terminated
