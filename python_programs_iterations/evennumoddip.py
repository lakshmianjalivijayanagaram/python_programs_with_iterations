#09-07-2024
#Write a program to print even numbers present in odd index positions
s=input()
...
2.fetch the index positions of every element in the given range
 checks that element is even and it is at odd index position or not
